...
export function register() {
                ...
                submenu: [
                    {
                        ...
                        checked: Preferences.getPreference<boolean>(
                            APP.preferences.minimizeToTray,
                        ),
                        click: (item) =>
    ...
    tray.on("double-click", () =>
        __mainWindow.isVisible() ? __mainWindow.hide() : __mainWindow.show(),
    );
}
